...
function addCheckbox(e) {
        ...
        if (selected === "Hot Black Tea") {
          ...
          document.getElementById("spanTag").innerHTML = "Hot Black Tea - Large ($1 extra)";
        } else if (selected === "Cold Coffee") {
          dynamicCheckbox.style.display = "block";
          checkboxSelectDynamic.value = "hi";
          document.getElementById("spanTag").innerHTML = "Cold Coffee - Large ($1 extra)";
        } else if (selected === "Lemon Ice Tea") {
          dynamicCheckbox.style.display = "block";
          checkboxSelectDynamic.value = "hi";
          document.getElementById("spanTag").innerHTML = "Lemon Ice Tea - Large ($1 extra)";
        } else if (selected === "Expresso") {
          dynamicCheckbox.style.display = "block";
          checkboxSelectDynamic.value = "hi";
          document.getElementById("spanTag").innerHTML = "Expresso - Large ($1 extra)";
        } else if (selected === "Latte") {
            dynamicCheckbox.style.display = "block";
            checkboxSelectDynamic.value = "hi";
            document.getElementById("spanTag").innerHTML = "Latte - Large ($1 extra)";
          }else {
